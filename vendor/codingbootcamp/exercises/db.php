...
class db {
    ...
    // database info - modify as needed for every project
    
    protected static $host = 'localhost';
    protected static $username = 'root';
    protected static $password = 'rootroot';
    protected static $database = 'party';
    ...
    *if the connection has nbeen made, it will just return the object, if not, it will first connect and then return it
...
//query je request pro databazi


    public static function query($sql, $substitution = [])
    {
        ...
        $outcome = $statement->execute($substitution);
